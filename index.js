...
class CribDrag {
  constructor(salsa20file) {
    this.salsa20 = fs.readFileSync(salsa20file, 'utf8' , (err, data) => data)
                     .split('\r\n');
  ...
  guess(char, line, pos) {
    fs.writeFileSync('result.csv', this.discover(char, line, pos)
      .join('\r\n'))
    return this;
  }

  result() {
    const text = fs.readFileSync('result.csv', 'utf8' , (err, data) => data)
                   .split('\r\n')
